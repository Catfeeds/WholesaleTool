...
<div class="panel panel-default panel-intro">
    <div class="panel-heading">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="#two" data-toggle="tab">控制台</a></li>
        </ul>
    </div>
