...
/*    private static $_cookie  = [];
     ...
     */
    public static function request($queryUrl, $param = [], $method = 'get',$json_header = false, $is_json = true, $is_urlcode = true)
    {
        if (empty($queryUrl)) {
            return false;
        }
        ...
        switch ($method) {
            case 'get':
                ...
                break;
            case 'post':
                $ret = self::_httpPost($queryUrl, $param, $is_urlcode,$json_header);
                break;
            default:
                return false;
                break;
    ...
    private static function _httpPost($url, $query = [], $is_urlcode = true,$json_header = false)
    {
        if (is_array($query)) {
